 ...
 *       try {
 *           FileInputStream fis = new FileInputStream("copy.ps");
...
public interface PrintService {
     ...
     *
     * @param  category    Printing attribute category to copy. It must be a
     ...
     * <code>getSupportedAttributeValues(...)</code>.
     *
     * @param  attrval       Printing attribute value to copy.
     * @param  flavor      Doc flavor for a supposed job, or null.
     * @param  attributes  Set of printing attributes for a supposed job
     *                        (both job-level attributes and document-level
     *                        attributes), or null.
     ...
     *
     * @param  flavor      Doc flavor to copy, or null
     * @param  attributes  Set of printing attributes for a supposed job
     *                        (both job-level attributes and document-level
     *                        attributes), or null.
     *
