...
public class MBeanPermission extends Permission {
    ...
    private static int getMask(String action) {
         ...
         *
         * The 'string length' copy must be performed for the lengthiest
         * strings first.
         *
         * In this permission if the "unregisterMBean" string length copy is
         * performed after the "registerMBean" string length copy the algorithm
