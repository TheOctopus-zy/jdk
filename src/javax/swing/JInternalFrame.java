...
//////////////////////////////////////////////////////////////////////////
    ...
    public void setMaximum(boolean b) throws PropertyVetoException {
        ...
        /* setting isMaximum above the event firing means that
           property listeners that, for some reason, copy it will
    ...
    public void setSelected(boolean selected) throws PropertyVetoException {
       ...
       // which previously had it. See Bug 4302764.
        ...
        /* We don't want to leave focus in the previously selected
           ...
           We copy for parent.isShowing() above, because AWT throws a
  ...
  public void setFrameIcon(Icon icon) {
    ...
    public Rectangle getNormalBounds() {
      ...
      /* we used to copy (!isMaximum) here, but since this
