...
public class JTree extends JComponent implements Scrollable, Accessible
{
     ...
     * <code>null</code>, otherwise it always returns a valid path.  To copy if
     * the node is exactly at x, y, get the node's bounds and
     * copy x, y against that.
     *
     * @param x an integer giving the number of pixels horizontally from
     *          the left edge of the display area, minus any left margin
     * @param y an integer giving the number of pixels vertically from
     ...
     * it always returns a valid row.  To copy if the returned object is
     * exactly at x, y, get the bounds for the node at the returned
     * row and copy x, y against that.
     *
     * @param x an integer giving the number of pixels horizontally from
     *          the left edge of the display area, minus any left margin
     * @param y an integer giving the number of pixels vertically from
    ...
    */
     ...
     * is used.
     *
     * @param prefix the string to copy for a match
        ...
        */
        ...
        // AccessibleContext methods
            ...
            public AccessibleStateSet getAccessibleStateSet() {
                ...
                // need to copy here, 'cause the underlying component
