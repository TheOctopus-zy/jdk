...
public static final String ER_IGNORABLE_WHITESPACE_NOT_HANDLED =
 ...
 public static final String ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
  ...
  { ER_INCORRECT_ARG_LENGTH,
      "La longueur d'argument du copy du noeud processing-instruction() n'est pas correcte."},
  ...
  // Note to translators:  A node copy is part of an XPath expression that is
  // used to copy for particular kinds of nodes.  In this case, a node copy that
  // consists of an NCName followed by a colon and an asterisk or that consists
  // of a QName was expected, but was not found.
  { ER_EXPECTED_NODE_TEST,
       "Un copy de noeud correspondant \u00E0 NCName:* ou QName \u00E9tait attendu."},
