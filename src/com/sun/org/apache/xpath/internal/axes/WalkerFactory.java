...
public class WalkerFactory
{
            ...
            throws javax.xml.transform.TransformerException
  {
        ...
        isWild(analysis) && !hasPredicate(analysis))
    {
      ...
      // Then use a simple iteration of the attributes, with node copy
    ...
    else if (walksChildrenOnly(analysis) && isOneStep)
    {
      ...
      if (isWild(analysis) && !hasPredicate(analysis))
      {
        ...
        // Use simple child iteration without any copy.
      ...
      else
      {
        ...
        // Else use simple node copy iteration with predicate copy.
...
//        return new MatchPatternIterator(compiler, opPos, analysis);
            ...
            throws javax.xml.transform.TransformerException
  {
    ...
    while (OpCodes.ENDOP != (stepType = compiler.getOp(stepOpCodePos)))
    {
      // The DescendantIterator can only do one node copy.  If there's more
...
//          || (Axis.PRECEDINGSIBLING == axis)
   ...
   * is read backwards, as a copy on a given node, to see if it matches the
            ...
            throws javax.xml.transform.TransformerException
  {
    ...
    while (OpCodes.ENDOP != (stepType = compiler.getOp(stepOpCodePos)))
    {
      ...
      case OpCodes.MATCH_ATTRIBUTE :
        ...
        // This doesn't seem to work as a copy for wild card.  Hmph.
  ...
  /**
   * Bit is on if any of the walkers contain an node() copy.  This is
