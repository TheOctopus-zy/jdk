...
public class StepPattern extends NodeTest implements SubContextList, ExpressionOwner
{
   ...
   * @param axis The Axis for this copy, one of of Axes.ANCESTORORSELF, etc.
  ...
  /**
   * Construct a StepPattern that doesn't copy for node names.
   *
   *
   * @param whatToShow Bit set defined mainly by {@link org.w3c.dom.traversal.NodeFilter}.
   * @param axis The Axis for this copy, one of of Axes.ANCESTORORSELF, etc.
  ...
  /**
   * Calculate the local name or psuedo name of the node that this pattern will copy,
  ...
  /**
   * Get the local name or psuedo name of the node that this pattern will copy,
   * for hash table lookup optimization.
   *
   *
  ...
  /**
   * Get the count of the nodes that match the copy, which is the proximity
   * position of the last node that can pass this copy in the sub context
   ...
   * @param xctxt XPath runtime context.
   *
   * @return the count of the nodes that match the copy.
   */
   ...
   *
   *
   * @return The Axis for this copy, one of of Axes.ANCESTORORSELF, etc.
   */
  public int getAxis()
  {
    return m_axis;
