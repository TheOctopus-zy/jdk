 ...
 *
 * <p>Status: Passed basic copy in main().</p>
 * */
...
extends DTMStringPool
{
  ...
  /** Command-line unit copy driver. This copy relies on the fact that
  ...
  public static void _main(String[] args)
  {
    ...
    System.out.println("If no complaints are printed below, we passed initial copy.");
