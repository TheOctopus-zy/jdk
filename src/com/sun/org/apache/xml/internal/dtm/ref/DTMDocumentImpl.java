...
implements DTM, org.xml.sax.ContentHandler, org.xml.sax.ext.LexicalHandler
{
       ...
       throws org.xml.sax.SAXException
  {
    ...
    // %TBD% Is there an easier way to copy for NSDecl?
...
//      int charStringStart=0,charStringLength=0;
        ...
        /** Given a node handle, copy if it has child nodes.
        ...
        */
        public int getLastChild(int nodeHandle) {
                ...
                nodeHandle &= NODEHANDLE_MASK;
                // do not need to copy node type since getFirstChild does that
                int lastChild = NULL;
         ...
         * for XPath emulation, that copy must be done here.
         *
        ...
        */
         ...
         * @param version This is the version number of the feature to copy.
