...
public class DOM2DTM extends DTMDefaultBaseIterators
{
 ...
 /**
                ...
                for(int i=0;i<attrsize;++i)
                  {
                    ...
                    // safer for now to copy the QName and trust the
   ...
   *
   * %REVIEW% This relies on being able to copy node-identity via
    ...
    if (DTM.ELEMENT_NODE == type)
    {
      ...
      while (DTM.NULL != (identity = getNextNodeIdentity(identity)))
      {
        ...
        type = _type(identity);
                                ...
                                // of both -- retrieve the node, then copy if the type matches
