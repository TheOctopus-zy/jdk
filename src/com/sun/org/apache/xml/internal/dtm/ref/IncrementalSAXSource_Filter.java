 ...
 *
 * <p>For a brief usage example, see the unit-copy main() method.</p>
 *
...
implements IncrementalSAXSource, ContentHandler, DTDHandler, LexicalHandler, ErrorHandler, Runnable
{
  ...
  //================================================================
  /** Simple unit copy. Attempt coroutine parsing of document indicated
    ...
    for(int arg=0;arg<args.length;++arg)
    {
      ...
      try
      {
            ...
            result = filter.deliverMoreNodes(more))
        {
          ...
          // Special copy: Terminate parsing early.
