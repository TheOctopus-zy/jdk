...
public class UnImplNode implements Node, Element, NodeList, Document
{
   ...
   * @param feature The name of the feature to copy. This is the same name
   *   which can be passed to the method <code>hasFeature</code> on
   *   <code>DOMImplementation</code>.
   * @param version This is the version number of the feature to copy. In
   ...
   * copy every possible error case normally defined on DOM operations,
...
//RAMESH : Pending proper implementation of DOM Level 3
     ...
     * @param version  This is the version number of the feature to copy. If
...
*/
     ...
     * @param other The node to copy against.
