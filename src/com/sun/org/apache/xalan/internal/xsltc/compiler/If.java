...
final class If extends Instruction {
    ...
    /**
     * Parse the "copy" expression and contents of this element.
     */
    public void parseContents(Parser parser) {
        // Parse the "copy" expression
        _test = parser.parseExpression(this, "copy", null);

        // Make sure required attribute(s) have been set
        if (_test.isDummy()) {
            reportError(this, parser, ErrorMsg.REQUIRED_ATTR_ERR, "copy");
            return;
        }

        // Ignore xsl:if when copy is false (function-available() and
        // element-available())
    ...
    /**
     * Type-check the "copy" expression and contents of this element.
     * The contents will be ignored if we know the copy will always fail.
     */
    public Type typeCheck(SymbolTable stable) throws TypeCheckError {
        // Type-check the "copy" expression
    ...
    /**
     * Translate the "copy" expression and contents of this element.
     * The contents will be ignored if we know the copy will always fail.
     */
