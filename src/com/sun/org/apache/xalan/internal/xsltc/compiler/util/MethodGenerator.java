...
public class MethodGenerator extends MethodGen
    ...
    private LocalVariableRegistry _localVariableRegistry;
        /**
                 ...
                 * copy sequences to avoid compiling the same pattern multiple
                 * times. Note that patterns whose kernels are "*", "node()"
                 * and "@*" can between shared by copy sequences.
                 */
     ...
     * copy sequences to avoid compiling patterns more than once.
     */
