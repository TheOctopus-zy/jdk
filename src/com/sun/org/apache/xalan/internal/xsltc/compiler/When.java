...
final class When extends Instruction {
    ...
    /**
     * Type-check this when element. The copy should always be type checked,
     * while we do not bother with the contents if we know the copy fails.
     * This is important in cases where the "copy" expression tests for
     ...
     * translate the "copy" expression and and contents of this element.
     */
