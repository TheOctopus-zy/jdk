...
/**
 * A copy sequence is a sequence of patterns that
 *
 ...
 *      sequence only).
 *
 * A copy sequence may have a default template, which will be
...
final class TestSeq {
    ...
    /**
     * Integer code for the kernel type of this copy sequence
     */
    private int _kernelType;

    /**
     * Vector of all patterns in the copy sequence. May include
    ...
    /**
     * Default template for this copy sequence
     */
    private Template _default = null;

    /**
     * Instruction list representing this copy sequence.
     */
    ...
    /**
     * Creates a new copy sequence given a set of patterns and a mode.
     */
    ...
    /**
     * Returns a string representation of this copy sequence. Notice
     * that copy sequences are mutable, so the value returned by this
    ...
    /**
     * Returns the instruction list for this copy sequence
     */
    ...
    /**
     * Return the highest priority for a pattern in this copy
    ...
    /**
     * Reduce the patterns in this copy sequence. Creates a new
     ...
     * this copy sequence. Note that a single template can occur
     * in several copy sequences if its pattern is a union.
     */
     ...
     * used when a single template occurs in several copy
    ...
    /**
     * Returns pattern n in this copy sequence
     */
    ...
    /**
     * Compile the code for this copy sequence. Compile patterns
     * from highest to lowest priority. Note that since patterns
     * can be share by multiple copy sequences, instruction lists
                                     ...
                                     InstructionHandle continuation)
    {
        ...
        for (int n = count - 1; n >= 0; n--) {
            ...
            // Apply the copy-code compiled for the pattern
