...
final class Predicate extends Expression implements Closure {
     ...
     * variables and local parameters passed in the closure to copy().
    ...
    private void compileFilter(ClassGenerator classGen,
        ...
        // Store the dom index in the copy generator
    ...
    /**
     * Returns true if the predicate is a copy for the existance of an
