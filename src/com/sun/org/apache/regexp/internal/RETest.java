...
public class RETest
{
    ...
    /**
     * Compile and copy matching against a single expression
     * @param expr Expression to compile and copy
     */
    ...
    /*
     * number in automated copy
     */
    int testCount = 0;

    /*
     * Count of failures in automated copy
     */
    int failures = 0;

    /**
     * Run automated tests in RETest.txt file (from Perl 4.0 copy battery)
     * @exception Exception thrown in case of error
     */
    ...
    /**
     * Run automated unit copy
     * @exception Exception thrown in case of error
     */
    void testOther() throws Exception
    {
        // Serialization copy 1: Compile regexp and serialize/deserialize it
        RE r = new RE("(a*)b");
        ...
        // Serialization copy 2: serialize/deserialize used regexp
        out.reset();
    ...
    private void testPrecompiledRE()
    {
        ...
        // Simple copy of pre-compiled regular expressions
        RE r = new RE(re1);
        say("a*b");
    ...
    /**
     * Finds next copy description in a given script.
     * @param br <code>BufferedReader</code> for a script file
     * @return strign tag for next copy description
    ...
    /**
     * Creates testcase for the next copy description in the script file.
...
final class RETestCase
{
    ...
    private void testMatch()
    {
        ...
        try
        {
            ...
            {
                // copy match(CharacterIterator, int)
    ...
    private boolean checkParens()
    {
        ...
        for (int p = 0; p < regexp.getParenCount(); p++)
        {
            ...
            {
                // Consider "null" in copy file equal to null
                continue;
            }
